...
// shared cortexkit DB (~/.local/share/cortexkit/mini-magic-context/context.db),
// which pi-plugin shares with OpenCode via @ufoq/mini-magic-context-core's
...
// Bulletproof DB guard (see @ufoq/mini-magic-context-core resolveDatabasePath): never
